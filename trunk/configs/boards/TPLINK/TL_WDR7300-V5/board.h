...
#define BOARD_PID               "TL_WDR7300-V5"
#define BOARD_NAME              "TL_WDR7300-V5"
#define BOARD_DESC              "TP-Link 7300-V5 Wireless Router"
#define BOARD_VENDOR_NAME       "TP-LINK Technologies CO., LTD."
#define BOARD_VENDOR_URL        "http://www.tp-link.com/en"
#define BOARD_MODEL_URL         "http://www.tp-link.com/en"
