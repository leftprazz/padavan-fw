...
UCHAR A_BAND_REGION_34_CHANNEL_LIST[]={36, 40, 44, 48, 52, 56, 60, 64, 132, 136, 140, 144};
UCHAR A_BAND_REGION_35_CHANNEL_LIST[]={36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 149, 153, 157, 165};
	...
	)
	{
		switch (pAd->CommonCfg.CountryRegionForABand & 0x7f)
		{
			...
			case REGION_21_A_BAND:
				...
				break;
			case REGION_34_A_BAND:
				num = sizeof(A_BAND_REGION_34_CHANNEL_LIST)/sizeof(UCHAR);
				pChannelList = A_BAND_REGION_34_CHANNEL_LIST;
				break;
			case REGION_35_A_BAND:
				num = sizeof(A_BAND_REGION_35_CHANNEL_LIST)/sizeof(UCHAR);
				pChannelList = A_BAND_REGION_35_CHANNEL_LIST;
				break;
